...
import { WeappAdminModule } from 'app/admin/admin.module';
import {
    ProjectComponent,
...
@NgModule({
    imports: [WeappSharedModule, WeappAdminModule, RouterModule.forChild(ENTITY_STATES)],
    declarations: [
        ProjectComponent,
        ProjectDetailComponent,
        ProjectUpdateComponent,
...
export class WeappProjectModule {}
